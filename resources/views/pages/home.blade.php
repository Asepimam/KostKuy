            ...
            <div class="swiper w-full overflow-x-hidden">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide !w-fit">
                        <a href="{{ route('boardingHouse.slug', $popularBoardingHouse->slug) }}" class="card">
                        <div
                            class="flex flex-col w-[200px] shrink-0 rounded-[30px] border border-[#F1F2F6] p-4 pb-5 gap-[10px] hover:border-[#91BF77] transition-all duration-300 my-2 mx-5 mt-20">
                            <div class="flex w-full h-[150px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                            <img src="{{ Storage::url($popularBoardingHouse->thumbnail) }}" class="w-full h-full object-cover" alt="thumbnail">
                            </div>
                            ...
                            <div class="flex items-center gap-[6px]">
                                ...
                                <p class="text-sm text-ngekos-grey">{{ $popularBoardingHouse->rooms->first()->capacity }} Rooms</p>
                            </div>
                            <hr class="border-[#F1F2F6]">
                            <p class="font-semibold text-lg text-ngekos-orange">
                                Rp {{ number_format($popularBoardingHouse->rooms->first()->price_per_month, 0, ',', '.') }}
                    ...
                    <a href="cities.html" class="card">
                        <div
                            ...
                            <div class="flex flex-col gap-[2px]">
                                ...
                                <p class="text-[10px] text-ngekos-grey"> 30 Kos</p>
                            </div>
                        </div>
                    </a>
                @endforeach
