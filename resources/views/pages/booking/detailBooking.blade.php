        ...
        <div class="accordion group flex flex-col rounded-[30px] p-5 bg-[#F5F6F8] mx-5 mt-5 overflow-hidden has-[:checked]:!h-[68px] transition-all duration-300">
            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-semibold">{{$booking->phone_number}}</p>
                </div>
            </div>
        </div>
        <div class="accordion group flex flex-col rounded-[30px] p-5 bg-[#F5F6F8] mx-5 mt-5 overflow-hidden has-[:checked]:!h-[68px] transition-all duration-300">
            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-semibold">{{ $booking->duration }} Months</p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="assets/images/icons/calendar.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <p class="font-semibold">{{ $booking->start_date }}</p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="assets/images/icons/calendar.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    {{-- start_date di kurangi duration --}}
                    <p class="font-semibold">1-sep-2030</p>
                </div>
            </div>
        </div>
        <div class="accordion group flex flex-col rounded-[30px] p-5 bg-[#F5F6F8] mx-5 mt-5 overflow-hidden has-[:checked]:!h-[68px] transition-all duration-300">
            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-semibold">Rp {{ number_format($booking->boardingHouse->price, 0, ',', '.') }}</p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="assets/images/icons/receipt-2.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="rounded-full p-[6px_12px] bg-ngekos-orange font-bold text-xs leading-[18px]">{{ $booking->status }}</p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="assets/images/icons/security-card.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <p class="rounded-full p-[6px_12px] bg-[#91BF77] font-bold text-xs leading-[18px]">{{ $booking->status }}</p>
                </div>
            </div>
        </div>
